  ...
  render() {
    ...
    return (
      <Page {...props}>
        ...
        <Card title={"Ritual Competition Forms"}>
            <a href="/pdf/ritualEvent.pdf">Universal Ritual Entry Form</a><br/>
        </Card>
        <Card title={"Membership Drive Information"}>
        ...
        <Card title={"Sweetheart Application"}>
